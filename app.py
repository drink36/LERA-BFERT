...
def client(name,ser_num):
    ...
    img1 = Image.open('pic/happy.png')
    tk_img1 = ImageTk.PhotoImage(img1)
    img2 = Image.open('pic/sad.png')
    tk_img2 = ImageTk.PhotoImage(img2)
    img3 = Image.open('pic/angry.png')
    tk_img3 = ImageTk.PhotoImage(img3)
    img4 = Image.open('pic/normal.png')
    tk_img4 = ImageTk.PhotoImage(img4)
    img5 = Image.open('pic/surprise.png')
    tk_img5 = ImageTk.PhotoImage(img5)
    img6 = Image.open('pic/avator.png')
    tk_img6 = ImageTk.PhotoImage(img6)
    img7 = Image.open('pic/disgust.png')
    tk_img7 = ImageTk.PhotoImage(img7)
    img8 = Image.open('pic/fear.png')
